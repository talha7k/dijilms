...
An educational platform for online learning. Key entities include Users (students/instructors), Courses, Lessons, Enrollments, and Payments.

### Important Constraints

The application must follow a serverless architecture using Firebase, be web-first, and focus on a SaaS subscription model.
...
3. Local application imports (`$lib/...`)
4. Relative imports (`./`, `../`)
