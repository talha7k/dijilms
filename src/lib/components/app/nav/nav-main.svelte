...
{#each appNavItems as mainItem (mainItem.title)}
  {#if (mainItem.title !== 'Teacher Portal' || $userProfile.data?.role === 'teacher') && (mainItem.title !== 'Student Portal' || $userProfile.data?.role === 'student') && (mainItem.title !== 'Parent Portal' || $userProfile.data?.role === 'parent')}
    <Sidebar.Group>
